...
<body>
    ...
    <div class="job-postings" id="job-postings">
        ...
        // Fetch IT-related job postings
        $sql = "SELECT location, job_type, salary, company_name, qualification, email FROM job_postings WHERE job_type = 'IT' ORDER BY id DESC";
