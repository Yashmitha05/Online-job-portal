...
<head>
    ...
    <title>Medicine Job Board</title>
    <style>
...
<body>
    ...
    <div class="job-postings" id="job-postings">
        ...
        // Fetch only Medicine job postings
        $sql = "SELECT location, job_type, salary, company_name, qualification, email FROM job_postings WHERE job_type = 'Medicine' ORDER BY id DESC";
    ...
    <script>
        document.querySelector('.filter-btn').addEventListener('click', function() {
            ...
            jobPostings.forEach(function(jobPosting) {
                ...
                if (locationMatch && salaryMatch && companyMatch && qualificationMatch) {
