...
<head>
    ...
    <title>Project Manager Job Board</title>
    <style>
...
<body>
    <h1>Project Manager Job Board</h1>
...
// Fetch job postings for both "Project Manager" and "Product Manager" roles
$sql = "SELECT location, job_type, salary, company_name, qualification, email 
        FROM job_postings 
        WHERE job_type LIKE '%Project Manager%' OR job_type LIKE '%Product Manager%' 
        ORDER BY id DESC";
